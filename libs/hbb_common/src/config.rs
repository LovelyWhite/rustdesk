...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("LiDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yc.lishop.cc"];
pub const PUBLIC_RS_PUB_KEY: &str = "kJPymtZDYvRPK+Pfm1wut1zfisZziHmD34tasdqrPKg=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "https://ycadmin.lishop.cc";
