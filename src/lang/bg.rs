...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Поради UAC, Lidesk в някои случай не може да работи правилно за отдалечена достъп. За да заобиколите UAC, моля, натиснете копчето по-долу, за да поставите Lidesk като системна услуга."),
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС следва да поставите Lidesk като системна услуга."),
        ...
        ("android_input_permission_tip2", "Моля, отидете на следващата страница с системни настройки, намерете и въведете [Installed Services], включете услугата [Lidesk Input]."),
        ...
        ("Language", "Език"),
        ("Keep Lidesk background service", "Запази работеща фонова услуга с Lidesk"),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да щракне върху OK в прозореца на UAC при стартиран Lidesk."),
