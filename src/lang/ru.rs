...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "В некоторых случаях из-за UAC LiDesk может работать неправильно на удалённом узле. Чтобы избежать возможных проблем с UAC, нажмите кнопку ниже для установки LiDesk в системе."),
        ...
        ("Turned off", "Отключён"),
        ("Language", "Язык"),
        ("Keep LiDesk background service", "Держать в фоне службу LiDesk"),
