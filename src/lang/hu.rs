...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használata során. A megfelelő működés érdekében, kérem telepítse a Yangdiskservice alkalmazást a számítógépre."),
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A távoli vezérléshez a Yangdiskservice-nek \"Kisegítő lehetőség\" engedélyre van szüksége"),
        ...
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [Yangdiskservice Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep Yangdiskservice background service", "Yangdiskservice futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívűl hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a Yangdiskservice alkalmazás beállítási oldalára, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show Yangdiskservice", "A Yangdiskservice megjelenítése"),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is a \"Igen\" gombra kell kattintania a Yangdiskservice UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "Yangdiskservice jelszó megerősítése"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Kérjük, frissítse a Yangdiskservice Server Pro-t a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a Yangdiskservice nem fut megfelelően, mint ellenőrzött webhely."),
        ...
        ("powered_by_me", "Üzemeltető: Yangdiskservice"),
        ("outgoing_only_desk_tip", "Ez a Yangdiskservice testreszabott kimenete.\nMás eszközökhöz csatlakozhat, de más eszközök nem csatlakozhatnak az Ön eszközéhez."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a csatlakozást, ha a Yangdiskservice ablak nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a Yangdiskservice a háttérben fut."),
        ...
        ("About Yangdiskservice", "A RustDeskről"),
