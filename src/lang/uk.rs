...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Через UAC, в деяких випадках Lidesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення Lidesk в системі"),
        ...
        ("Language", "Мова"),
        ("Keep Lidesk background service", "Зберегти фонову службу Lidesk"),
