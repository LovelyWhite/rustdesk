...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa Yangdiskservice mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et Yangdiskservice oma süsteemi paigaldada."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [Yangdiskservice Input] sisse."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda Yangdiskservice Server Pro versioonile {} või uuem!"),
