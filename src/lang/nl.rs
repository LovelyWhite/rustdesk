...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het Yangdiskservice netwerk..."),
        ...
        ("install_tip", "U gebruikt een niet geïnstalleerde versie. Als gevolg van UAC-beperkingen is het in sommige gevallen niet mogelijk om als controleterminal de muis en het toetsenbord te bedienen of het scherm over te nemen. Klik op de knop hieronder om Yangdiskservice op het systeem te installeren om het bovenstaande probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Click to download", "Klik om te downloaden"),
        ("Click to update", "Klik om bij te werken"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw bureaublad op afstand te kunnen bedienen, moet u Yangdiskservice \"toegankelijkheid\" toestemming geven."),
        ("config_screen", "Om toegang te krijgen tot het externe bureaublad, moet u Yangdiskservice de toestemming \"schermregistratie\" geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u Yangdiskservice toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [Yangdiskservice Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep Yangdiskservice background service", "Yangdiskservice achtergronddienst behouden"),
        ...
        ("Show Yangdiskservice", "Toon Yangdiskservice"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ...
        ("config_input", "Om het externe bureaublad vanaf het toetsenbord te kunnen bedienen, moet u Yangdiskservice de rechten \"Invoerbewaking\" geven."),
        ("config_microphone", "Om op afstand te kunnen chatten, moet u Yangdiskservice 'Audio opnemen' rechten geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende Yangdiskservice."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord Yangdiskservice"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om Yangdiskservice te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Upgrade Yangdiskservice Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor Yangdiskservice mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het Yangdiskservice-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt Yangdiskservice op de achtergrond actief te houden"),
        ...
        ("About Yangdiskservice", "Over Yangdiskservice"),
