...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, LiDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, LiDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Language", "Dil"),
        ("Keep LiDesk background service", "LiDesk arka plan hizmetini sürdürün"),
