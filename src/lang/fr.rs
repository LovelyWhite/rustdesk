...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à LiDesk."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à LiDesk l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser LiDesk à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [LiDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep LiDesk background service", "Gardez le service LiDesk en arrière plan"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à LiDesk l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à LiDesk les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de LiDesk en cours d'éxécution."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour LiDesk Server Pro avec la version {} ou une version plus récente !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher LiDesk de fonctionner correctement en tant que machine contrôlé."),
