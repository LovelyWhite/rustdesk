...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau Yangdiskservice..."),
        ...
        ("install_tip", "Yangdiskservice n'est pas installé, ce qui peut limiter son utilisation à cause de l'UAC. Cliquez ci-dessous pour l'installer."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à Yangdiskservice."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à Yangdiskservice l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser Yangdiskservice à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [Yangdiskservice Input]."),
        ...
        ("Language", "Langue"),
        ("Keep Yangdiskservice background service", "Gardez le service Yangdiskservice en arrière plan"),
        ...
        ("Show Yangdiskservice", "Afficher Yangdiskservice"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à Yangdiskservice l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à Yangdiskservice les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de Yangdiskservice en cours d'éxécution."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe Yangdiskservice"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser Yangdiskservice et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour Yangdiskservice Server Pro avec la version {} ou une version plus récente !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher Yangdiskservice de fonctionner correctement en tant que machine contrôlé."),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre Yangdiskservice est ouverte"),
