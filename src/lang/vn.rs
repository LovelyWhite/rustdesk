...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Yangdiskservice..."),
        ...
        ("install_tip", "Do UAC, Yangdiskservice sẽ không thể hoạt động đúng cách là bên từ xa trong vài trường hợp. Để tránh UAC, hãy nhấn cái nút dưới đây để cài Yangdiskservice vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Click to download", "Nhấn để tải xuống"),
        ("Click to update", "Nhấn để cập nhật"),
        ("Configure", "Cài đặt"),
        ("config_acc", "Để có thể điều khiển máy tính từ xa, bạn cần phải cung cấp quyền \"Trợ năng\" cho Yangdiskservice"),
        ("config_screen", "Để có thể truy cập máy tính từ xa, bạn cần phải cung cấp quyền \"Ghi Màn Hình\" cho Yangdiskservice."),
        ("Installing ...", "Đang cài ..."),
        ("Install", "Cài"),
        ("Installation", "Cài"),
        ...
        ("android_input_permission_tip1", "Để thiết bị từ xa điều khiển thiết bị Android của bạn bằng chuột hoặc chạm, bạn cần cho phép Yangdiskservice sử dụng dịch vụ \"Trợ năng\"."),
        ("android_input_permission_tip2", "Vui lòng chuyển đến trang cài đặt hệ thống tiếp theo, tìm và nhập [Dịch vụ đã cài đặt], bật dịch vụ [Yangdiskservice Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Yangdiskservice background service", "Giữ dịch vụ nền Yangdiskservice"),
        ("Ignore Battery Optimizations", "Bỏ qua các tối ưu pin"),
        ("android_open_battery_optimizations_tip", "Nếu bạn muốn tắt tính năng này, vui lòng chuyển đến trang cài đặt ứng dụng Yangdiskservice tiếp theo, tìm và nhập [Pin], Bỏ chọn [Không hạn chế]"),
        ...
        ("Show Yangdiskservice", "Hiện Yangdiskservice"),
        ("This PC", ""),
        ("or", "hoặc"),
        ...
        ("config_input", "Để điều khiển được máy tính từ xa với bàn phím, bạn cần cho phép Yangdiskservice quyền \"Theo dõi đầu vào\" (Input Monitoring)"),
        ("config_microphone", "Để nói chuyện từ xa, bạn phải cho phép Yangdiskservice quyền \"Ghi âm thanh\" (Record Audio)"),
        ...
        ("still_click_uac_tip", "Vẫn cần người dùng từ xa nhấn OK trên cửa sổ UAC của Yangdiskservice đang chạy."),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Yangdiskservice"),
