...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep Lidesk background service", "Mantieni il servizio di Lidesk in background"),
