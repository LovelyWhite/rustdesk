...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "У некаторых выпадках Lidesk можа працаваць няправільна на аддаленым вузле з-за UAC. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўстаноўкі Lidesk у сістэме."),
        ...
        ("Language", "Мова"),
        ("Keep Lidesk background service", "Захаваць фонавую службу Lidesk"),
