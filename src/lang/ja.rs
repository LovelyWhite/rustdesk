...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "次の端末設定ページに進み、「インストール済みアプリ」から「Yangdiskservice Input」を有効にしてください。"),
        ...
        ("Turned off", "オフになりました"),
        ("Language", "言語"),
        ("Keep Yangdiskservice background service", "Yangdiskservice バックグラウンドサービスを維持"),
        ...
        ("Show Yangdiskservice", "RustDeskを表示"),
        ("This PC", "このPC"),
        ("or", "または"),
        ("Continue with", "で続行"),
        ("Elevate", "昇格"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Yangdiskservice Server Proをバージョン{}以上にアップグレードしてください！"),
        ...
        ("About Yangdiskservice", "RustDeskについて"),
