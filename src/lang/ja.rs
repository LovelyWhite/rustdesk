...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "オフになりました"),
        ("Language", "言語"),
        ("Keep Lidesk background service", "Lidesk バックグラウンドサービスを維持"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lidesk Server Proをバージョン{}以上にアップグレードしてください！"),
