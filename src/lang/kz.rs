...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "UAC кесірінен, Lidesk кейбірде қашықтағы жақ ретінде дұрыс жұмыс істей алмайды. UAC'пен қиындықты болдырмау үшін, төмендегі батырманы басып Lidesk'ті жүйеге орнатыңыз."),
        ...
        ("Language", "Тіл"),
        ("Keep Lidesk background service", "Артжақтағы Lidesk сербесін сақтап тұру"),
