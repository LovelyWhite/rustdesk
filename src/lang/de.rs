...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann Lidesk in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren Lidesk auf dem System."),
        ...
        ("Language", "Sprache"),
        ("Keep Lidesk background service", "Lidesk im Hintergrund ausführen"),
