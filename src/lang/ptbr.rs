...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Devido ao UAC, o Lidesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Lidesk no sistema."),
        ...
        ("Language", "Idioma"),
        ("Keep Lidesk background service", "Manter o serviço do Lidesk executando em segundo plano"),
