...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti Lidesk netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte Lidesk į savo kompiuterį."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep Lidesk background service", "Palikti Lidesk fonine paslauga"),
