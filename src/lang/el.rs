...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Λόγω UAC, το LiDesk ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το LiDesk στο σύστημα"),
        ...
        ("Language", "Γλώσσα"),
        ("Keep LiDesk background service", "Εκτέλεση του LiDesk στο παρασκήνιο"),
