...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Yangdiskservice..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Yangdiskservice v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ...
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Yangdiskservice Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Yangdiskservice background service", "Ohrani RustDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Yangdiskservice, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Za nadzor oddaljenega namizja s tipkovnico, rabi Yangdiskservice pravico »Nadzor vnosa«."),
        ("config_microphone", "Za zajem zvoka, rabi Yangdiskservice pravico »Snemanje zvoka«."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za Yangdiskservice"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite Yangdiskservice, prekinite klic in program zaprite."),
        ("scam_text2", "Yangdiskservice omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite Yangdiskservice Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo Yangdiskservice"),
        ...
        ("floating_window_tip", "Pomaga pri Yangdiskservice storitvi v ozadju"),
        ...
        ("About Yangdiskservice", "O RustDesku"),
