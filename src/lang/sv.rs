...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "På grund av UAC, kan inte LiDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera LiDesk på systemet."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep LiDesk background service", "Behåll LiDesk i bakgrunden"),
