...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Yangdiskservice..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Yangdiskservice fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Yangdiskservice på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge Yangdiskservice \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Yangdiskservice \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Yangdiskservice Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep Yangdiskservice background service", "Behåll Yangdiskservice i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Yangdiskservice programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show Yangdiskservice", "Visa Yangdiskservice"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
