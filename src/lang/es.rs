...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que LiDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar LiDesk a nivel de sistema."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep LiDesk background service", "Dejar LiDesk como Servicio en 2do plano"),
