...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, Lidesk ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian Lidesk sistema mailan instalatzeko."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep Lidesk background service", "Mantendu Lidesk atzeko planoko zerbitzu bezala"),
