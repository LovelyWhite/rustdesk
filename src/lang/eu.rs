...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yangdiskservice sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, Yangdiskservice ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian Yangdiskservice sistema mailan instalatzeko."),
        ...
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, Yangdiskservice-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, Yangdiskservice-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, Yangdiskservice \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [Yangdiskservice Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep Yangdiskservice background service", "Mantendu Yangdiskservice atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez Yangdiskservice aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show Yangdiskservice", "Erakutsi Yangdiskservice"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, Yangdiskservice-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den Yangdiskservice UAC leihoan"),
        ...
        ("verify_rustdesk_password_tip", "Berretsi Yangdiskservice pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta Yangdiskservice erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu Yangdiskservice Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek Yangdiskservice kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "Yangdiskservice-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa Yangdiskservice leihoa irekita badago"),
        ...
        ("floating_window_tip", "Yangdiskservice atzeko planoko zerbitzua mantentzen laguntzen du"),
