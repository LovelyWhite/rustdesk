...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "På grund af UAC kan Lidesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere Lidesk på systemet"),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep Lidesk background service", "Behold Lidesk baggrundstjeneste"),
