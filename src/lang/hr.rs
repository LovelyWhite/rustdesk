...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC-a Lidesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate Lidesk na sustav."),
        ...
        ("Language", "Jezik"),
        ("Keep Lidesk background service", "Zadrži Lidesk kao pozadinski servis"),
