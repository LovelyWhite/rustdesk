...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. Lidesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت Lidesk في جهازك."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep Lidesk background service", "ابق خدمة Lidesk تعمل في الخلفية"),
