...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, LiDesk nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar LiDesk në sistem."),
        ...
        ("Turned off", "I fikur"),
        ("Language", "Gjuha"),
        ("Keep LiDesk background service", "Mbaje shërbimin e sfondit të LiDesk"),
