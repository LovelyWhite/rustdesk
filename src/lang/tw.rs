...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 LiDesk 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 LiDesk 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Click to download", "點選以下載"),
        ("Click to update", "點選以更新"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 LiDesk「協助工具」權限。"),
        ...
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep LiDesk background service", "保持 LiDesk 後台服務"),
