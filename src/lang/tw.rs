...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 Yangdiskservice 網路..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 Yangdiskservice 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 Yangdiskservice 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Click to download", "點選以下載"),
        ("Click to update", "點選以更新"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 Yangdiskservice「無障礙功能」權限。"),
        ("config_screen", "為了遠端存取您的桌面，您需要授予 Yangdiskservice「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您的 Android 裝置，您需要允許 Yangdiskservice 使用「輔助功能」服務。"),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「Yangdiskservice Input」服務。"),
        ...
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep Yangdiskservice background service", "保持 Yangdiskservice 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一個 Yangdiskservice 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制」"),
        ("Start on boot", "開機時啟動"),
        ...
        ("Show Yangdiskservice", "顯示 Yangdiskservice"),
        ("This PC", "此電腦"),
        ("or", "或"),
        ("Continue with", "繼續"),
        ("Elevate", "提升權限"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 Yangdiskservice「輸入監控」權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 Yangdiskservice「錄音」權限。"),
        ...
        ("still_click_uac_tip", "依然需要遠端使用者在執行 Yangdiskservice 時於 UAC 視窗點選「是」。"),
        ...
        ("verify_rustdesk_password_tip", "驗證 Yangdiskservice 密碼"),
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "您可能遭遇詐騙！"),
        ("scam_text1", "如果您正在和素不相識的人通話，而對方要求您使用 Yangdiskservice 啟用服務，請勿繼續操作並立即掛斷電話。"),
        ...
        ("selinux_tip", "SELinux 處於啟用狀態，Yangdiskservice 可能無法作為被控端正常運作。"),
        ("Change view", "更改檢視方式"),
        ("Big tiles", "大磁磚"),
        ("Small tiles", "小磁磚"),
        ("List", "清單"),
        ...
        ("powered_by_me", "由 Yangdiskservice 提供支援"),
        ...
        ("allow-only-conn-window-open-tip", "只在 Yangdiskservice 視窗開啟時允許連接"),
        ...
        ("floating_window_tip", "有助於保持 Yangdiskservice 後台服務"),
        ...
        ("About Yangdiskservice", "關於 Yangdiskservice"),
