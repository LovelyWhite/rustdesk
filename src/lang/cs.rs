...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k Yangdiskservice síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), Yangdiskservice v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak Yangdiskservice do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Click to download", "Stáhnout"),
        ("Click to update", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci Yangdiskservice udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci Yangdiskservice udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby Yangdiskservice mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [Yangdiskservice vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep Yangdiskservice background service", "Zachovat službu Yangdiskservice na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace Yangdiskservice, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show Yangdiskservice", "Zobrazit Yangdiskservice"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění Yangdiskservice \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění Yangdiskservice \"Nahrávat zvuk\"."),
        ...
        ("verify_rustdesk_password_tip", "Ověření hesla Yangdiskservice"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby Yangdiskservice a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte prosím Yangdiskservice Server Pro na verzi {} nebo novější!"),
        ...
        ("powered_by_me", "Poháněno společností Yangdiskservice"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno Yangdiskservice"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu Yangdiskservice na pozadí"),
        ...
        ("About Yangdiskservice", "O Yangdiskservice"),
