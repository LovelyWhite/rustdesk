...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC Yangdiskservice ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Yangdiskservice na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, Yangdiskservice-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Yangdiskservice-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite Yangdiskservice-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [Yangdiskservice Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Yangdiskservice aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on boot", ""),
        ...
        ("Show Yangdiskservice", "Prikazi Yangdiskservice"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
