...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "En alguns casos és possible que el Lidesk no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el Lidesk al vostre sistema."),
        ...
        ("Language", "Idioma"),
        ("Keep Lidesk background service", "Manté el servei del Lidesk en rerefons"),
