...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca LiDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala LiDesk."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep LiDesk background service", "Rulează serviciul LiDesk în fundal"),
